...
for dropout_rate in list_dropout:
    ...
    for a1_a2 in list_a1_a2:
        ...
        for n_layer in range(i, i + 1):
            ...
            list_loss_train,list_loss_valid,best_loss = run_train_valid_with_batch(data_input, tensor_input_train, tensor_input_valid, learning_rate, epochs=epochs, batch_size=batch_size)
