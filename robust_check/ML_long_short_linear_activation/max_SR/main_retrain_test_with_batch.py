...
for port_type in port_type_list:
    ...
    list_loss_ins,F_ins,F_oos,ret_pred_ins,ret_pred_oos,x_ins,x_oos,net = run_ins_oos_with_batch(data_input, tensor_input_ins, tensor_input_oos, learning_rate, batch_size=batch_size)
