    ...
    for char_type in chars_use_list:
        for port_type in port_type_list:
            for oos_target in oos_target_list:
                ...
                save_dir = f'./results_{char_type}/{port_type}_3folds_period_{oos_target}_with_batch/{bm_type}'
                            ...
                            for dropout_rate in list_dropout:
                                for a1_a2 in list_a1_a2:
                                    ...
                                    for cross_validate in cross_validation_list:
                                        output_dir = f'./results_{char_type}/{port_type}_validation_3folds_period_{oos_target}_with_batch_{batches}_{cross_validate}/{bm_type}'
