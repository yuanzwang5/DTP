...
class Net_SR(torch.nn.Module):  
    ...
    def forward(self, x, 
        ...
        # ----- Weight Smoothing, Turnover Consideration, and Transaction Cost Calculation ----- #
        # w_ Exponential Smoothing： w_tilde_0 = w_0,  w_tilde_t = (1-gamma)*w_t + gamma*w_tilde_{t-1}
