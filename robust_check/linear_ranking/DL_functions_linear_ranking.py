...
def run_ins_oos(data_input,
    ...
    net.eval()
    with torch.no_grad():
        _, F_ins, weight_ins_3200, x_ins_3200 = net(tensor_input_ins, print_state = state)
        _, F_oos, weight_oos_3200, x_oos_3200 = net(tensor_input_oos, sample_period='oos', print_state = state)
    
    return list_loss_ins,F_ins,F_oos,weight_ins_3200,weight_oos_3200,x_ins_3200,x_oos_3200,list_grad,net
